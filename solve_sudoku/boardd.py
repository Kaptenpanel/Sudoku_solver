...
def find_candidates(empty_cell: Cell, board: list[Cell]):
    ...
    candidates = list(filter(lambda candidate: candidate not in col_values, candidates))

    candidates = list(filter(lambda candidate: candidate not in row_values, candidates))
